...
export default function SobreMi() {
  ...
  usePageMeta(ABOUT_CONTENT.seoTitle, ABOUT_CONTENT.seoDescription, {
    ...
    ogTitle: "Sobre mí | Psicóloga Marcela Zamora",
    ogDescription:
      "Conocé el enfoque cálido y profesional de Marcela Zamora en Volver al Presente.",
  });
    ...
    <main>
      <section className="innerHero">
        <div className="container innerHero__content">
          ...
          <h1>Un espacio cálido, profesional y humano para volver al presente</h1>
          <p>{ABOUT_CONTENT.intro}</p>
          <div className="innerHero__cta">
            <Link className="btn btn-secondary" to="/servicios">Ver áreas de acompañamiento</Link>
      ...
      <section className="section">
        <div className="container singleColumn">
          <article className="card sectionCard warmCard">
            <h2>{ABOUT_CONTENT.whyTitle}</h2>
            {ABOUT_CONTENT.whyParagraphs.map((paragraph) => (
              <p key={paragraph}>{paragraph}</p>
            ))}
            <p>
              Volver al Presente también recuerda que el bienestar no es ausencia de dolor,
              sino capacidad de respuesta frente a la vida real.
            </p>
          </article>
        </div>
      </section>
      ...
      <section className="section">
        <div className="container infoGrid">
          <article className="card sectionCard">
            ...
            <p><strong>Misión:</strong> {ABOUT_CONTENT.mission}</p>
            <p><strong>Visión:</strong> {ABOUT_CONTENT.vision}</p>
            <h3>Valores</h3>
            <ul>
          ...
          <article className="card sectionCard">
            ...
            <p>
              Si querés conocer el servicio más adecuado para lo que estás viviendo,
              podés revisar la sección de <Link to="/servicios">servicios</Link>.
            </p>
          </article>
        </div>
      </section>
      ...
      <section className="section mutedSection">
        <div className="container singleColumn">
          <article className="card sectionCard ctaCard">
            <h2>Gracias por llegar hasta acá</h2>

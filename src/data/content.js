...
export const BRAND_VALUES = [
  {
    ...
    description:
      "Antes de cualquier técnica, priorizo que te sintás acompañada, escuchada y respetada.",
  },
  {
    title: "Basada en evidencia",
    description:
      "Integro herramientas con respaldo clínico adaptadas a tu historia, ritmo y objetivos.",
  },
  {
    title: "Objetivos claros",
    description:
      "Trabajamos con foco terapéutico para que el proceso tenga dirección y sentido para vos.",
  },
  {
    title: "Cuidado integral",
    description:
      "Tu bienestar emocional se construye considerando cuerpo, mente, vínculos y contexto de vida.",
  },
  {
    title: "Ética y respeto",
    description:
      "Confidencialidad, responsabilidad profesional y trato humano en cada etapa del acompañamiento.",
  },
];
...
export const HOME_CONTENT = {
  ...
  heroTitle:
    "Psicoterapia en Costa Rica para volver al presente con calma, claridad y bienestar emocional",
  heroSubtitle:
    "Soy Marcela Zamora, psicóloga en Costa Rica. Acompaño procesos terapéuticos con calidez humana, claridad clínica y enfoque basado en evidencia.",
  valueTitle: "¿Qué significa Volver al Presente?",
  valueText:
    "Es una invitación a regresar a ese lugar interno donde podés escucharte sin juicio, comprender lo que te pasa y responder con más recursos. No buscamos una vida perfecta: buscamos una vida habitable, con sostén emocional incluso cuando las aguas se mueven.",
  ...
  finalCtaText:
    "Podemos coordinar por WhatsApp o agendar directamente tu cita psicológica en Costa Rica. No necesitás llegar con todo claro: empezamos desde donde estás.",
};
...
export const ABOUT_CONTENT = {
  ...
  intro:
    "Hola, soy Marcela Zamora, psicóloga en Costa Rica. Desde hace más de 12 años acompaño a personas que están atravesando ansiedad, duelo, trauma, depresión, estrés o crisis vitales. Creo profundamente que todas las personas pueden volver a sentirse en casa dentro de sí mismas.",
  whyTitle: "¿Por qué nace Volver al Presente?",
  whyParagraphs: [
    "Volver al Presente nació al observar que mucho del sufrimiento emocional aparece cuando vivimos atrapadas entre lo que ya pasó y lo que todavía no ocurre. El presente no borra el dolor, pero sí nos devuelve un lugar real de cambio.",
    "Para mí, bienestar emocional no es vivir en aguas siempre tranquilas; es aprender a navegar la danza entre aguas tranquilas y turbulentas con más recursos, compasión y claridad.",
  ],
  ...
  finalCtaText:
    "Si sentís que llegó el momento de iniciar terapia, será un gusto acompañarte. Podemos coordinar por WhatsApp o por agenda online.",
};
